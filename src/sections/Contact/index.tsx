    ...
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="contact h-[250px] flex items-center justify-around p-4">
          <ul>
            <li className="text-[23px] my-2 font-[600] text-whiteGray opacity-90">
              Telefon:{" "}
              <span className="text-[15px] font-[400]">+993 (61) 192228</span>
            </li>
            <li className="text-[23px] my-2 font-[600] text-whiteGray opacity-90">
              Email:{" "}
              <span className="text-[15px] font-[400]">
                nazar.se7en@gmail.com
              </span>
            </li>
            <li className="text-[23px] my-2 font-[600] text-whiteGray opacity-90">
              Instagram:{" "}
              <span className="text-[15px] font-[400]">yollo.com.tm</span>
            </li>
            <li className="text-[23px] my-2 font-[600] text-whiteGray opacity-90">
              Tiktok:{" "}
              <span className="text-[15px] font-[400]">yollo.com.tm</span>
        ...
        <div className="contact h-[250px] flex items-center justify-around p-4">
          <ul>
            <h3 className="text-[23px] font-[600] text-whiteGray opacity-90">
              Salgymyz:
            </h3>
            <li className="text-[21px] font-[600] text-whiteGray opacity-90">
              <span className="text-[15px] font-[400]">
                Jl. Tanjung Barat Selatan, Gang 100 no. 26 Jakarta Selatan
              </span>
            </li>
          </ul>
